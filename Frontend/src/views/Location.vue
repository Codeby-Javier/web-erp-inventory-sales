    ...
    <div class="page-header d-print-none mb-4">
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <h2 class="page-title">Lokasi Gudang</h2>
        </div>
          ...
          <table class="table card-table table-vcenter text-nowrap datatable">
            ...
            <tbody>
              ...
              <tr v-else-if="items.length === 0">
                <td colspan="5" class="text-center text-muted py-4">Data lokasi kosong.</td>
              </tr>
...
const deleteItem = async (item) => {
  if (confirm(`Apakah Anda yakin ingin menghapus lokasi "${item.name}"?`)) {
    try {
      await api.delete(`/crud/locations/${item.id}`)
      fetchData()
    } catch (error) {
